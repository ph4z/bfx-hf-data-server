...
class DataServer {
  ...
  client (wsURL) {
    ...
    debug('websocket dataserver client connected to', wsURL)
  }
  /**
   * Write data from websocket client into the database
   */
  wsWrite (msg) {
    debug('websocket dataserver client connected to', this.port)
    submitAlert(msg)
  }
  /**
